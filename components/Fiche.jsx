            ...
            <div className="flex flex-col gap-2">
                <ul className="flex">
                    {months.map((month, index) => {
                        return (
                            <li key={index} className="py-1 text-xl w-[30px] text-center">{month[0].toUpperCase()}</li>
                        )
                    })}
                </ul>
                <ul className="flex">
                {months.map((month, index) => {
                    if(semisPeriod.includes(month)){
                        return (
                            <li key={index} className="py-1 border-2 text-md bg-brownSemis text-third font-semibold w-[30px] text-center">S</li>
                        )
                    }
                    return (
                        <li key={index} className="py-1 border-2 text-sm w-[30px] text-center">--</li>
                    )
                })}
                </ul>
                <ul className="flex">
                {months.map((month, index) => {
                    if(plantationPeriod.includes(month)){
                        return (
                            <li key={index} className="py-1 border-2 text-md bg-greenPlantation text-third font-semibold w-[30px] text-center">P</li>
                        )
                    }
                    return (
                        <li key={index} className="py-1 border-2 text-sm w-[30px] text-center">--</li>
                ...
                {months.map((month, index) => {
                    if(recoltePeriod.includes(month)){
                        return (
                            <li key={index} className="py-1 border-2 text-md bg-orangeRecolte text-third font-semibold w-[30px] text-center">R</li>
                        )
                    }
                    return (
                        <li key={index} className="py-1 border-2 text-sm w-[30px] text-center">--</li>
